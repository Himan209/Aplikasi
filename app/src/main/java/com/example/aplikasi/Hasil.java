...
public class Hasil extends AppCompatActivity {
    ...
    TextView zodiakmu, nama_zodiak, isi_zodiak, prediksi, isi_prediksi;
    ImageView logo_zodiak;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        isi_prediksi = findViewById(R.id.isi_prediksi);
        logo_zodiak = findViewById(R.id.logo_zodiak);
        ...
        if ((Integer.parseInt(date1)>21 && Integer.parseInt(month) == 12) || (Integer.parseInt(date1)<=19 && Integer.parseInt(month) == 1)){
            //logo_zodiak.setImageResource(R.drawable.capricorn);
            nama_zodiak.setText("Capricorn");
            isi_zodiak.setText("Orang yang lahir pada tanggal antara 21 Desember sampai 19 Januari berada di bawah pengaruh zodiak Capricorn, yang berlambang kambing. Orang yang berzodiak Capricorn mengutamakan kesuksesan, status, posisi, reputasi");
            isi_prediksi.setText("Capricorn memang bercita – cita mencari kekuasaan dalam karir sehingga Anda harus siap bekerja dengan tekun");
        }



        if ((Integer.parseInt(date1)>20 && Integer.parseInt(month) == 1) || (Integer.parseInt(date1)<=18 && Integer.parseInt(month) == 2)){
            logo_zodiak.setImageResource(R.drawable.aquarius);
            ...
            isi_prediksi.setText("Kelahiran Aquarius ini biasanya tekun bekerja dan ingin orang lain sama tekun dalam bekerja sama. Lantaran itu, Aquarius menyukai karir yang mengikat");
        }


        if ((Integer.parseInt(date1)>19 && Integer.parseInt(month) == 2) || (Integer.parseInt(date1)<=20 && Integer.parseInt(month) == 3)){
            logo_zodiak.setImageResource(R.drawable.pisces);
            ...
            isi_prediksi.setText("Orang berzodiak Pisces suka pada pujian dan mengharapkan ungkapan cinta dari kekasih." +
        ...
        if ((Integer.parseInt(date1)>21 && Integer.parseInt(month) == 3) || (Integer.parseInt(date1)<=20 && Integer.parseInt(month) == 4)){
            logo_zodiak.setImageResource(R.drawable.aries);
            ...
            isi_prediksi.setText("Aries punya daya pesona yang tinggi. Dalam pergaulan, Aries kelihatan lincah, pintar, berkeperibadian kuat dan teman bual yang mengasyikan. ");
        }


        if ((Integer.parseInt(date1)>21 && Integer.parseInt(month) == 4) || (Integer.parseInt(date1)<=20 && Integer.parseInt(month) == 5)){
            logo_zodiak.setImageResource(R.drawable.taurus);
            ...
            isi_prediksi.setText("Cancer dan Virgo adalah pasangan yang ideal bagi Taurus. Cancer memang pendamping tepat bagi Taurus. Keperibadian Cancer yang matang dan tidak berubah – ubah sesuai dengan cita rasa Taurus. ");
        }


        if ((Integer.parseInt(date1)>21 && Integer.parseInt(month) == 5) || (Integer.parseInt(date1)<=20 && Integer.parseInt(month) == 6)){
            logo_zodiak.setImageResource(R.drawable.gemini);
        ...
        if ((Integer.parseInt(date1)>21 && Integer.parseInt(month) == 6) || (Integer.parseInt(date1)<=20 && Integer.parseInt(month) == 7)){
            logo_zodiak.setImageResource(R.drawable.cancer);
            ...
            isi_prediksi.setText("Seseorang yang berperibadian yang matang adalah pasangan yang ideal buat Cancer. Di sini, zodiak Taurus dan Virgo merupakan pendamping yang ideal bagi Cancer.");
        }


        if ((Integer.parseInt(date1)>21 && Integer.parseInt(month) == 7) || (Integer.parseInt(date1)<=21 && Integer.parseInt(month) == 8)){
            logo_zodiak.setImageResource(R.drawable.leo);
            ...
            isi_prediksi.setText("Leo suka bergaul sehingga tidak dapat berdampingan dengan seseorang yang cemburu dan mengungkung. Dalam situasi ini, Libra, Sagitarius, dan Taurus adalah pendamping ideal buat Leo. ");
        }


        if ((Integer.parseInt(date1)>22 && Integer.parseInt(month) == 8) || (Integer.parseInt(date1)<=22 && Integer.parseInt(month) == 9)){
            logo_zodiak.setImageResource(R.drawable.virgo);
            ...
            isi_prediksi.setText("Zodiak Cancer dapat menjadi teman atau kekasih yang baik bagi Virgo. Sementara bersama Virgo yang serius, Cancer yang cemburu; tidak akan merasa resah. ");
        }


        if ((Integer.parseInt(date1)>23 && Integer.parseInt(month) == 9) || (Integer.parseInt(date1)<=22 && Integer.parseInt(month) == 10)){
            logo_zodiak.setImageResource(R.drawable.libra);
            ...
            isi_prediksi.setText("Libra adalah seorang kekasih yang cerdas dan selalu menjaga perbuatan dan pertuturannya agar kekasihnya tidak tersinggung. Pendamping yang ideal buat Libra adalah Taurus dan Leo.");
        }


        if ((Integer.parseInt(date1)>23 && Integer.parseInt(month) == 10) || (Integer.parseInt(date1)<=22 && Integer.parseInt(month) == 11)){
            logo_zodiak.setImageResource(R.drawable.scorpio);
            ...
            isi_prediksi.setText("Orang yang bernaung di bawah lambang Taurus dan Cancer merupakan pendamping yang sesuai untuk Scorpio. Taurus adalah pedamping yang diperlukan oleh Scorpio.");
        }


        if ((Integer.parseInt(date1)>23 && Integer.parseInt(month) == 11) || (Integer.parseInt(date1)<=20 && Integer.parseInt(month) == 12)){
            logo_zodiak.setImageResource(R.drawable.sagittarius);
            ...
            isi_prediksi.setText("Sagitarius seorang kekasih yang setia. Pasangan yang dilakukan adalah bukan dari jenis yang cemburu. Jadi, pasangan yang cocok dengan Sagitarius adalah Aries dan Gemini.");
        }
    }
}
